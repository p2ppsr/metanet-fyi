...
export const resources = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'BRC-76 · GASP', url: 'https://github.com/bsv-blockchain/BRCs/blob/master/overlays/0076.md', owner: 'BRCs', status: 'Exploratory origin', note: 'The original graph-aware synchronization proposal. Use the current GASP package docs for implementation behavior.' },
      ...
      { title: 'BRC-136 · BASM', url: 'https://github.com/bsv-blockchain/BRCs/blob/master/overlays/0136.md', owner: 'BRCs', status: 'Current extension', note: 'Per-block synchronization for confirmed transaction completeness within an overlay topic.' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: '@bsv/gasp', url: 'https://github.com/bsv-blockchain/ts-stack/tree/main/packages/overlays/gasp', owner: 'BSV Blockchain', status: 'Current implementation', note: 'Graph-aware synchronization that discovers unknown outputs and recursively retrieves required ancestors.' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'BRC-59 · Overlay benefits', url: 'https://github.com/bsv-blockchain/BRCs/blob/master/overlays/0059.md', owner: 'BRCs', status: 'Opinion / rationale', note: 'The scalability and security case for application-specific overlay networks.' },
